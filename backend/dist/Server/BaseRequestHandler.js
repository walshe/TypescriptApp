...
var BaseRequestHandler = /** @class */ (function () {
    ...
    BaseRequestHandler.prototype.respondJsonObject = function (code, object) {
        this.res.writeHead(code, {
            "Content-Type": "application/json"
        });
        this.res.write(JSON.stringify(object));
    };
    BaseRequestHandler.prototype.respondBadRequest = function (message) {
        this.res.statusCode = Model_1.HTTP_CODES.BAD_REQUEST;
        this.res.write(message);
    };
    BaseRequestHandler.prototype.respondText = function (code, text) {
        this.res.statusCode = code;
        this.res.write(text);
    };
    BaseRequestHandler.prototype.respondUnauthorized = function () {
